    ...
    public partial class init_mig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderItemId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_OrderDetails_bags_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_shopping_carts", x => new { x.CartId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_shopping_carts_bags_ProductId",
                        column: x => x.ProductId,
                        principalTable: "bags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
